...
int  i=0;
int mult 1000; // time in seconds to ms for readability
const long t0=40*mult;
const long t1=41*mult;
const long t2=81*mult;
const long t3=82*mult;
const long t4=984*mult;
const long t5=1968*mult;
const long t6=2968*mult;
const long t7=31488*mult; // set timer
...
void setup(){
  ...
  Serial.println("prgram start here...");
...
currentMillis = millis();
  if((currentMillis - pretime >= t4) && (boolean_t[4]==1)){  // t4=984s(1000s)
...
// end of Generation 2
  ...
  if((currentMillis - pretime >= t5) && (boolean_t[5]==1)){  // t5=1968s(2000s)
    digitalWrite(sv[2],LOW); // sv3 from ON to OFF
  ...
  if((currentMillis - pretime >= t6) && (boolean_t[6]==1)){  // t6=2968s(3000s)
  ...
  if((currentMillis - pretime >= t7) && (boolean_t[7]==1)){  // t4=3148s(3180s)
